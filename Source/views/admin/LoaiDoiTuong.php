<div id="LoaiDoiTuong-content" class="container h-full">
    <div class="flex items-center justify-between mb-4">
        <h1>Quản lý Loại đối tượng</h1>
        <div class="flex items-center gap-4">
            ...
            <button type="button" class="action-item btn btn-primary create-target hidden" data-act="LoaiDoiTuong-them">Thêm Loại đối tượng</button>
        </div>
    </div>
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-4">
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <button type="button" class="btn btn-primary" id="btn-loc" data-act="LoaiDoiTuong-loc">Lọc</button>
            </div>
            <div>
